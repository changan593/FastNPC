...
from fastnpc.config import CHAR_DIR, TEMPLATES_DIR, STATIC_DIR, FRONTEND_ORIGINS, BASE_DIR
...
os.makedirs(AVATAR_DIR.as_posix(), exist_ok=True)
app.mount(
    "/avatars",
    StaticFiles(directory=AVATAR_DIR.as_posix()),
    name="avatars",
)
print(f"[INFO] 已挂载头像目录: {AVATAR_DIR}")
